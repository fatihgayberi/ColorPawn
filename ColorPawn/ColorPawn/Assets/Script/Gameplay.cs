...
public class Gameplay : MonoBehaviour
{
    ...
    void TouchAndControl()
    {
        ...
        {
            if (hitArea.transform.name.Contains("region") && RegionEmptyControl(hitArea)) /* secilen objenin region olup olmadigini anlamaya calisir ve ustunde pawn var mi kontrol eder */
            {
